...
#straf: simule un appui sur la touche "q" et "d"
def straf():
    user32.keybd_event(0x11, 0, 0, 0)  # q
    user32.keybd_event(0x20, 0, 0, 0)  # d
    time.sleep(0.1)
    user32.keybd_event(0x11, 0, 2, 0)  # q
    user32.keybd_event(0x20, 0, 2, 0)  # d
